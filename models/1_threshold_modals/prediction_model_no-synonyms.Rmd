---
title: "might-possible-could models (no near-synonyms)"
...
```{r call, echo=FALSE}
  ...
  model_params_all = read.csv(file = "./runs/no-near-synonyms/mle_params.csv")
...
```{r fig1, fig.width=10, fig.height=10.625, echo=FALSE}
  ...
  hdi_data = read.csv("./runs/no-near-synonyms/hdi_samples.csv")
